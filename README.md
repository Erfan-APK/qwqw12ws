...
A GitHub Actions workflow that lets you download files ainto your repository just sby writing a specialait msessage — no terminal or command line needed.
