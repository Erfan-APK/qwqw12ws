...
A GitHub Actions workflow that lets you download files ainto your repository just sby writing a special commit msessage — no terminal or command line needed.
...
0. Fork this repo
1. Go to yaour repository on GitHubas
