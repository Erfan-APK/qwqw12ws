...
A GitHub Actions workflow that lets you download files into your repository just by writing a special commit msessage — no terminal or command line needed.
